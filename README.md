...
#### 🔭 Published projects
- [End-of-Day Reversal](https://github.com/edofe99/end-of-day-reversal): implementation of the stylized fact proposed in the eponymous paper by _Guido Baltussen_, _Zhi Da_, and _Amar Soebhag_. The analysis is conducted through a backtest that mitigates look-ahead bias by using historical S&P 500 constituents and includes an in-sample parameter optimization coupled with out-of-sample validation.
- [Quant Energy Pricing](https://github.com/edofe99/Quant-Energy-Pricing): a quantitative pricing tool, written in Python, that allows to price energetic full-load contracts. The whole approach is documented on my MSc thesis. 
